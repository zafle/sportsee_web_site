...
/**
 * Renders the Authentification Form React Component to display on home page.
...
function AuthentificationForm() {
     ...
     * Saves isMock value into context and localstorage (true if "mock", false if "api")
     ...
     * Saves clicked button's value into context and localstorage.
